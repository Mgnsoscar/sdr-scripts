...
CLI
───
    fm_chirp_2MHz_tx.py --freq 1575.42 --rate 200 --power -30
    fm_chirp_2MHz_tx.py --freq 1575.42 --gain 60 --filter on --passband 2.4   # clean band-limit
    fm_chirp_2MHz_tx.py --self-test        # verify seamless phase closure (+ filter), no hardware
    fm_chirp_2MHz_tx.py --describe-params  # paramkit JSON schema for the GUI
"""
